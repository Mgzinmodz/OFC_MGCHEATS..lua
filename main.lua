-- // MG HUB UI - VISUAL FFH4X STYLE (CORRIGIDO COMPLETO)
...
-- // Verifica suporte a desenhos (ESP/FOV)
...
-- // Variáveis Fly (corrigido: uma única conexão)
...
local function startFly()
    ...
    flyConnection = RunService.RenderStepped:Connect(updateFlyVelocity)
end
...
-- // Criação das abas (agora completa)
